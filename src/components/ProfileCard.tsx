      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            {/* User info bar — outside luminosity layer so button renders with true color */}
            {showUserInfo && (
              <div
                style={{
                  gridArea: '1 / -1',
              ...
              >
                ...
                >
                  ...
                  <button
                    className="cursor-pointer transition-all duration-200 ease-out hover:-translate-y-0.5 hover:brightness-110 active:scale-95"
                    ...
                    style={{
                      ...
                      color: 'var(--cream)',
                      border: 'none',
                      boxShadow: '0 2px 10px rgba(59,151,151,0.45)',
                    }}
                    type="button"
